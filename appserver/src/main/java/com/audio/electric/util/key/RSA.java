package com.audio.electric.util.key;
...
public class RSA {
	public static void main(String[] args){
		...
		try {
			...
			String enstr = RSA.encrypt("yangwu", publicKey);
			String data = RSA.decrypt(enstr,privateKey);
			System.out.println("加密前为：yangwu");
			System.out.println("解密后为："+data);

			String sign = sign("yangwugege",privateKey);
			boolean flag = checkSign("yangwugege",sign,publicKey);
	...
	public static boolean checkSign(String content, String sign, String publicKey)
	{
		try 
		{
			...
			byte[] h = Base64.decode2(sign);
			System.out.println(new String (h));
			boolean bverify = signature.verify( h);
			return bverify;

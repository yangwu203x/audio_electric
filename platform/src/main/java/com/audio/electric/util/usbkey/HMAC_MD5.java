package com.audio.electric.util.usbkey;
...
public class HMAC_MD5 {
    ...
    public HMAC_MD5(byte[] paramArrayOfByte)
     ...
     * @return
     */
    public static String ecrpt(String keyt,String value){
        String key = Constant.KEY;
        HMAC_MD5 localHMAC_MD5 = null;
        try {
            localHMAC_MD5 = new HMAC_MD5(keyt.getBytes());
            localHMAC_MD5.addData(value.getBytes());
            byte[] arrayOfByte1 = localHMAC_MD5.sign();
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
        }

        return localHMAC_MD5.toString();
    }
    ...
    public static void main(String[] paramArrayOfString)
    {
        ...
        try
        {
            HMAC_MD5 localHMAC_MD5 = new HMAC_MD5(str1.getBytes());

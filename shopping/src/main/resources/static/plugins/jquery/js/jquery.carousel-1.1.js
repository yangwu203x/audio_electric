(function($){
    ...
    var carouselsEvo = function(element, options){
        var settings = $.extend({}, $.fn.carousels.defaults, options),
            self = this,
            element = $(element),
            carousels = element.children('.slides');

        carousels.children('div').addClass('slideItem');
        var slideItems = carousels.children('.slideItem'),
        ...
        var horizonPos = function(p){
            ...
            if (p == 0){
                if (o.hAlign == 'center'){
                    hPos = (o.carouselsWidth - o.frontWidth)/2;
                }
                else {
                    hPos = o.left ;
                    if (o.hAlign == 'right'){
                ...
                if (o.hAlign == 'center'){
                    if (p > 0 && p <= Math.ceil((n-1)/2)){
                        ...
                        if (mod == 0){
                            if (p == endSlide){
                                hPos = (o.carouselsWidth - setSlideSize(p).width)/2 ;
                            }
                        }
                    }
                    else{
                        hPos = o.carouselsWidth - horizonPos(n-p) - setSlideSize(p).width;
                    }
                }
                else {
                    if (p == (n -1)){
        ...
        var initSlides = function(){
            ...
            carousels
                .css({'width':o.carouselsWidth+'px', 'height':o.carouselsHeight+'px'})
            ...
            // if (o.mouse == true){
            //     carousels.mousewheel(function(event, delta){
            //         if (delta > 0){
        ...
        var showVideoOverlay = function(index){
            if (slideItems.eq(index).children('a').hasClass('video')){
                carousels.children('.videoOverlay').show();
            }
        };
        ...
        var addVideoContent = function(){
            var vo = carousels.children('.videoOverlay'),
        ...
        var videoOverlayClick = function(event){
            addVideoContent();
            carousels.children('.spinner').show();
            $(this).hide();
    ...
    $.fn.carousels = function(options){
        ...
        for(var i=0; i < this.length; i++){
            if(!this[i].carousels){
                this[i].carousels = new carouselsEvo(this[i], options);
                this[i].carousels.init();
            }
            returnArr.push(this[i].carousels);
        }
    ...
    $.fn.carousels.defaults = {
        ...
        backOpacity:1,
        before: function(carousels){},
        after: function(carousels){}
    };

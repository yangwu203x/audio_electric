...
@Aspect
@Component
public class IsLoginAspectJson {

    private final static Logger logger = LoggerFactory.getLogger(IsLoginAspectJson.class);


    @Pointcut("@annotation(com.enter.annotations.LoginVerifyJson)")
